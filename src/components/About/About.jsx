...
const T = {
  en: {
    ...
    bio: [
      ...
      "Today I wear a few hats. I'm a builder who ships AI products myself. I co-founded Caramel Lab as its CTO, a live AI SaaS for STEM and science students in Korea that reached 10,000 users within two months of launch, with Meve coming next. I wrote the entire stack solo, from the Google Gemini pipelines that power its AI features to the payment and subscription system behind them. And I'm a creator: I share the building, the founder life, and everything in between with a community of 50K+ on Instagram. I'm not a founder who hands the building to someone else. I'm a founder who can build it, and tell the story too.",
    ],
  ...
  ko: {
    ...
    bio: [
      ...
      '지금은 여러 역할을 동시에 하고 있어요. 저는 AI 제품을 직접 만드는 빌더입니다. 한국 STEM·과학 학생을 위한 라이브 AI SaaS인 카라멜랩을 공동창업해 CTO를 맡고 있고, 이 제품은 런칭 두 달 만에 유저 1만 명을 달성했습니다. 다음으로는 Meve를 출시할 예정입니다. AI 기능을 구동하는 Google Gemini 파이프라인부터 그 뒤의 결제·구독 시스템까지 전체 스택을 혼자 작성했습니다. 그리고 저는 크리에이터이기도 합니다. 만드는 과정과 창업가의 삶, 그 사이의 모든 것을 인스타그램 5만+ 커뮤니티와 나눕니다. 저는 만드는 일을 남에게 맡기는 창업가가 아니라, 직접 만들 수 있고 그 이야기까지 전하는 창업가입니다.',
    ],
    currentlyTitle: '현재',
    currently: [
