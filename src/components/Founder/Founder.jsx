...
const T = {
  en: {
    ...
    intro: [
      ...
      "That first company taught me how to run user interviews and pitch a vision. Then I taught myself to build, and now I'm the co-founder and CTO of Caramel Lab, where I built the entire product on my own, from the AI pipelines to the payments. I went from a founder with an idea to a founder who can build the whole thing.",
    ],
    ...
    milestones: [
      ...
      { year: '2026', desc: 'Co-founded Caramel Lab as CTO, an AI SaaS for STEM students (March 2026)' },
      { year: '2026', desc: 'Shipped Caramel Lab to production with paying subscribers' },
      { year: '2026', desc: 'Reached 10,000 users within two months of launch' },
    ],
  },
  ko: {
    label: '창업 여정',
    ...
    intro: [
      ...
      '그 첫 회사에서 사용자 인터뷰를 진행하고 비전을 피칭하는 법을 배웠습니다. 그다음엔 스스로 만드는 법을 익혔고, 지금은 카라멜랩의 공동창업자이자 CTO로서 AI 파이프라인부터 결제까지 제품 전체를 혼자 만들었습니다. 아이디어만 있던 창업가에서, 전부를 직접 만들 수 있는 창업가가 되었습니다.',
    ],
    ...
    milestones: [
      ...
      { year: '2026', desc: 'STEM 학생을 위한 AI SaaS, 카라멜랩 공동창업 및 CTO (2026년 3월)' },
      { year: '2026', desc: '카라멜랩을 프로덕션에 출시, 유료 구독자 확보' },
      { year: '2026', desc: '런칭 두 달 만에 유저 1만 명 달성' },
    ],
  },
}
